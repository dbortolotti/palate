...
OMDb also fills country, language, runtime, and series season count when available.
...
- `palate_remember`: store a taste memory with required description text and fetch movie or series ratings from OMDb
