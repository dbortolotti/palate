...
const items = [
  {
    ...
    attributes: { oak: 0.82, premium: 0.95, richness: 0.78, intensity: 0.84, classic: 0.9, indulgent: 0.75 },
    signals: [
      { type: "rating", value: 5 },
  ...
  },
  {
    ...
    attributes: { oak: 0.68, premium: 0.78, richness: 0.72, intensity: 0.76, classic: 0.82 },
    signals: [
      { type: "rating", value: 4 },
  ...
  },
  {
    ...
    attributes: { quiet: 0.78, intellectual: 0.92, premium: 0.88, indulgent: 0.62, classic: 0.65 },
    signals: [
      { type: "rating", value: 5 },
      { type: "saved", value: true }
    ]
  ...
  },
  {
    ...
    attributes: { intellectual: 0.95, quiet: 0.88, classic: 0.9, comfort: 0.72 },
    signals: [
      { type: "rating", value: 5 },
      { type: "tried", value: true }
    ]
...
console.log(`Seeded ${items.length} Palate entities.`);
